  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        {/* Özel Katılımcı Bilgileri */}
        {config.specialFields && event.participants && Object.keys(event.participants).length > 0 && (
          <div className="space-y-2">
            ...
            <div className="grid grid-cols-1 gap-2">
              {config.specialFields.map((field: any) => {
                const value = event.participants[field.key];
                return value ? (
